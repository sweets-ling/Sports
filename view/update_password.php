...
<body>
    ...
    <div id="wrapper">
       ...
       <ul class="nav navbar-top-links navbar-right">
               ...
               <li>
                   <a href="cover.php"> <span class="m-r-sm text-muted welcome-message">Sport＋</span></a>
                </li>
                    <li class="active">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <a href="update_password.html"><strong>修改密码</strong></a>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="col-lg-7">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>修改密码<small>这是一个修改密码的事例</small></h5>
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">修改密码</h3>
                                <p>这是一个描述</p>
                                <form role="form">
                                    <div class="form-group"><label>新密码</label> <input type="email" placeholder="Enter Password" class="form-control"></div>
                                    <div class="form-group"><label>再次输入</label> <input type="password" placeholder="Password Again" class="form-control"></div>
                                    <div>
                                        <button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit"><strong>确定</strong></button>
                                        <label> <input type="checkbox" class="i-checks"> 记住我 </label>
                                    </div>
                                </form>
                            </div>
