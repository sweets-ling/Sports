    ...
    <div id="wrapper">
       ...
       <ul class="nav navbar-top-links navbar-right">
            ...
            <div class="row wrapper border-bottom white-bg page-heading text－center">
                <div class="col-lg-9 ">
                    <h2 class="text－center">我的兴趣组</h2>
                    <ol class="breadcrumb text－center">
                        <li>
                            <a href="index.html">首页</a>
                        </li>
                         <li>
                            <strong class="text－center">加入＋</strong>
                        </li>
                        <li class="active">
                            <strong class="text－center">创建</strong>
                        </li>
                        <li class="active">
                            <strong class="text－center">管理</strong>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="contact-box">
                    ...
                    <div class="col-sm-4">
                        ...
                        <hr/>
                            <img alt="image" class="img  img-responsive" src="../../img/p1.jpg">
                            <hr/>
                    ...
                    <div class="col-sm-8">
                       <h3><strong>组团大作业！</strong></h3>
                        <p><i class="fa fa-map-marker"></i>汉口路20号</p>
                        <address>
                            我们的征途是星辰大海！
                        </address>
