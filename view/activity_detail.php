                    ...
                    <div class="card">
                        <div class="card-block">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="m-b-md">
                                            <a onclick="joinActivity(<?php echo $activityDetail['id'] ?>)" class="btn btn-white btn-xs pull-right">加入</a>
                                            <h2><?php echo $activityDetail['name'] ?></h2>
                                        </div>
                                        <dl class="dl-horizontal">
                                            <dt>状态：</dt> <dd><span class="label label-primary">正在进行</span></dd>
                                        </dl>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-5">
                                        <dl class="dl-horizontal">
                                            <dt>创建者:</dt> <dd><a href="homepage.php?userid=<?php echo $activityDetail['userid'] ?>" class="text-navy"> <?php echo $activityDetail['username'] ?></a> </dd>
<br/>
                                            <dt>开始时间:</dt> <dd> <?php echo $activityDetail['begintime'] ?></dd>

                                        <dt>结束时间:</dt> <dd> <?php echo $activityDetail['endtime'] ?> </dd>
                                        </dl>
                                    </div>
                            ...
                            <div class="row dl-horizontal col-lg-9">
                                <dt>描述:</dt> <dd><?php echo $activityDetail['description'] ?></dd>
                            </div>
                            ...
                            <div class="row m-t-sm">
                                    <div class="col-lg-12">
                                            ...
                                            <div class="panel-body">
                                                        ...
                                                        <div class="feed-activity-list">
                                                            ...
                                                            <div class="feed-element">
                                                                <a href="#" class="pull-left">
                                                                    <img alt="image" class="img-circle" src="<?php echo $y['imgurl']?>">
                                                                </a>
                                                ...
                                                <br/>
                                                <div class="chat-form">
                                                    <form role="form" action="../controller/Activity/comment.php?aid=<?php echo $activityDetail['id'] ?>" method="post">
                                                        <div class="form-group" hidden="">
                                                            <input name="uid" class="form-control" value="<?php echo $userid?>" placeholder="快来发表你的评论吧！"/>
                                                        </div>
                                                        <div class="form-group">
                                                            <textarea name="text" class="form-control" placeholder="快来发表你的评论吧！"></textarea>
                                                        </div>
