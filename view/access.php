    ...
    <div id="wrapper">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    <li class="active">
                        <strong style="color: #19aa8d">设置权限</strong>
                    </li>
                    <li class="active">
                        <a href="data.php">导入数据</a>
                    </li>
                ...
                <div  class="col-xs-12 col-md-8 ">
                    <div class="card">
                        <div class="card-block">
                            <blockquote>
                                <p class="text-primary">编辑权限</p>
                            </blockquote>



                            <div class="ibox-content text-center">
                                <form method="post" class="form-horizontal text-center" action="../controller/Login/updateAccess.php">
                                    <div class="form-group"><label class="col-sm-4 control-label" >用户邮箱</label>

                                        <div class="col-sm-6"><input type="email"  name="email" class="form-control"  placeholder="请输入用户邮箱"></div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group"><label class="col-sm-4 control-label">选择权限</label>
                                        <div class="col-sm-6 row">

                                         <label> <input type="radio" value="0" name="a"> <i></i>普通用户 </label>

                                         <label> <input type="radio"  value="1" name="a"> <i></i>认证教练 </label>


                                           <label> <input type="radio"  value="2" name="a"> <i></i>认证医生 </label>
                                           <label> <input type="radio"  value="3" name="a"> <i></i>系统管理员</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="hr-line-dashed"></div>
                                     <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-3">
                                            <button class="btn btn-white" ><a href="access.php">取消设置</a></button>
                                            <button class="btn btn-primary" type="submit"> 更新权限</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
