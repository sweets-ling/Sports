...
<head>
    ...
    <link href='<?=base_url().'_static/font-awesome/css/font-awesome.min.css'?>' rel="stylesheet">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand" href="index.php/Login/loginini">个人中心</a>
                </div>
        ...
        <div class="item active">
            <div class="container">
                ...
                <br/>
                    ...
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;现在开始，进入我的自律之旅！</p>
                    <p>
                        <a class="btn btn-lg btn-primary" href="#" role="button">发现更多</a>
...
<script src='<?=base_url().'_static/js/plugins/wow/wow.min.js'?>'></script>
