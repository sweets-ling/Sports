                ...
                <div class="col-lg-9 ">
                    ...
                    <ol class="breadcrumb text－center">
                        <li>
                         ...
                         <li class="active">
                          <a href="message.html"> 私信</a>
                           
                        </li>
                        <li >
                         <a href="notice.html"><strong class="text－center">通知</strong></a>
                    ...
                    <div class="chat-form">
                            <form role="form">
                                ...
                                <div class="text-right">
                                    <button type="submit" class="btn btn-sm btn-primary m-t-n-xs"><strong>已读</strong></button>
                                </div>
                            </form>
                        </div>
