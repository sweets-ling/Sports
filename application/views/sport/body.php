                ...
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb">
                      ...
                      <a href="../other/index.html">首页</a>
                        ...
                        <li class="active">
                            <a href="body.html"><strong>身体</strong></a>
                        </li>
                        <li >
                       ...
                       <br/><br/>
                         ...
                         <div class="col-md-9">
                           <div class="progress progress-striped active">
                                ...
                                <div style="width: 30%" class="progress-bar progress-bar-navy">
...
<blockquote>
 ...
 <br/>
                     ...
                     <div class="col-md-6"> <button type="button" class="margin－bottom btn btn-primary btn-sm btn-block"><i class="fa fa-child"></i>添加</button></div>
