                ...
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb">
                      ...
                      <a href="../other/index.html">首页</a>
                        ...
                        <li >
                            <a href="sports.html"><strong>运动</strong></a>
                        </li>
                        <li class="active">
...
<br/>
                         ...
                         <div class="col-md-9">
                               <div class="progress progress-striped">
                                <div style="width: 30%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" role="progressbar" class="progress-bar progress-bar-success">
                                    <span class="sr-only">40% Complete (success)</span>
                                </div>
                            </div>
...
<br/>
                         ...
                         <div class="col-md-9">
                               <div class="progress progress-striped">
                                <div style="width: 70%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" role="progressbar" class="progress-bar progress-bar-danger">
                                    <span class="sr-only">40% Complete (success)</span>
                                </div>
                            </div>
